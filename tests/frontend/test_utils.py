...
class TestCalculateDelta(unittest.TestCase):
    ...
    def test_calculate_delta_positive_change(self):
        ...
        result = calculate_delta(
            current_value=Decimal("1200.00"), previous_value=Decimal("1000.00")
        )
    ...
    def test_calculate_delta_negative_change(self):
        ...
        result = calculate_delta(
            current_value=Decimal("800.00"), previous_value=Decimal("1000.00")
        )
    ...
    def test_calculate_delta_no_change(self):
        ...
        result = calculate_delta(
            current_value=Decimal("1000.00"), previous_value=Decimal("1000.00")
        )
    ...
    def test_calculate_delta_no_previous_value(self):
        ...
        result = calculate_delta(current_value=Decimal("1000.00"), previous_value=None)
    ...
    def test_calculate_delta_previous_value_zero(self):
        ...
        result = calculate_delta(
            current_value=Decimal("100.00"), previous_value=Decimal(0)
        )
